    ...
    <div className="flex min-h-screen items-center justify-center bg-cream px-4 py-12">
      <div className="w-full max-w-sm rounded-3xl border border-beige/70 bg-white/60 p-8 shadow-2xl shadow-sage-deep/10 backdrop-blur-md">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="mt-2 rounded-full bg-gradient-to-r from-sage to-gold px-5 py-2.5 text-sm font-semibold text-charcoal transition hover:brightness-105"
          >
            Ingresar
          </button>
        </form>
        ...
        <Link
          to="/"
          className="mt-5 flex items-center justify-center gap-1.5 text-sm font-medium text-muted transition hover:text-ink"
        >
